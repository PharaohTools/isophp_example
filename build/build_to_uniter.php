...
echo "        Copying uniter constants from {$client_parent}constants_uniter_prod.fephp to {$client_root}core".DIRECTORY_SEPARATOR."constants_uniter_prod.{$target_extension} \n";
system("cp -r {$client_parent}constants_uniter_prod.fephp {$client_root}core".DIRECTORY_SEPARATOR."constants_uniter_prod.{$target_extension}");