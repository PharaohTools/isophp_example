...
var fs = require('fs'),
    ...
    files = globby.sync([
        ...
        __dirname + '/www/app/*/View/desktop/*.php',
        __dirname + '/www/app/*/View/mobile/*.php',
        __dirname + '/www/app/*/View/web/*.php',
        __dirname + '/www/app/*/View/*.php',
        __dirname + '/www/app/*.' + extension ,
        __dirname + '/www/app/*/*.' + extension ,
        __dirname + '/www/app/*/*/*.' + extension ,
        __dirname + '/www/app/*/*/*.' + extension ,
        __dirname + '/www/app/*/View/*.' + extension ,
        __dirname + '/www/core/*.' + extension ,
        __dirname + '/www/core/*/*.' + extension ,
        __dirname + '/www/core/*/*/*.' + extension ,
        __dirname + '/www/core/*/*/*/*.' + extension
    ]),
...
fs.writeFileSync(
    __dirname + '/www/uniter_bundle/app_file_data.js',
    'module.exports = ' + JSON.stringify(app_file_data) + ';'
);
console.log("\n\ncore_data\n", JSON.stringify(core_file_data)) ;
fs.writeFileSync(
    __dirname + '/www/uniter_bundle/core_file_data.js',
...
fs.writeFileSync(
    __dirname + '/www/uniter_bundle/file_index.fephp',
    file_string
);
fs.writeFileSync(
