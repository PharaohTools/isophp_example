			...
			<div class="container">
				<div class="row animate-box">
					...
					<div class="col-md-12 text-center fh5co-heading">
						...
						<p class="larger_paragraph">
							Build native applications for any major platform in a single codebase. Lots of Web
							Applications use a PHP Back End with a Front End built in one of the Javascript
                            ...
                            Think Angular, Meteor or Derby PHP, or a React PHP for Front End. We can have them all
...
<a href="https://source.internal.pharaohtools.com/index.php?control=RepositoryHome&action=show&item=uniter_php_socketio">
                                        ...
                                        and back end is written in PHP.<br />
                                        Create true real time associations between your Client and your Server.
                                        Using native integration of WebSockets, you can specify variables.
                                        Organize your code into Components with designer-friendly HTML templates.
                                        Easily specify live bindings between the view and model so that when
                                        data changes, the view updates instantly.
									</p>
...
&lt;<span style="color: blue;">/script</span>&gt;</pre>
                                    ...
                                    <div class="col-sm-6">
                                       <pre class="CodeExample">
                                           <iframe src="xuniter-iframe.html"></iframe>
                                       </pre>
                                    </div>
                                    <div class="col-sm-12">
                                        <h2 class="link_title">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="col-md-12 feature-center">
									<span class="feature_icon icon">
										<div class="fullWidth">
        ...
        <strong>download the code for this Website</strong></a>, which
				...
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center">
                        <span class="link_get_started btn btn-primary btn-lg">Get Started</span>
					</div>
				</div>
			</div>
		</div>
